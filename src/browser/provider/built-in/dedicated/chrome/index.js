...
export default {
    ...
    async _setupNativeAutomation ({ browserClient, runtimeInfo, nativeAutomationOptions }) {
        ...
        runtimeInfo.nativeAutomationOptions = nativeAutomationOptions; // store for isolated session creation
    },
    ...
    // create/dispose isolated browser contexts via CDP
    ...
    async getBrowserLevelCDPClient (browserId) {
        return this.openedBrowsers[browserId].browserClient.getBrowserLevelClient();
    },
